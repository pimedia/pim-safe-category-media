...
add_action( 'cmb2_admin_init', 'pscm_register_demo_metabox' );
/**
 * Hook in and add a demo metabox. Can only happen on the 'cmb2_admin_init' or 'cmb2_init' hook.
 */
function pscm_register_demo_metabox() {
	/**
	 * Sample metabox to demonstrate each field type included
	 */
	$cmb_demo = new_cmb2_box( array(
		'id'            => 'pscm_demo_metabox',
		'title'         => esc_html__( 'Test Metabox', 'cmb2' ),
		'object_types'  => array( 'page' ), // Post type
		// 'show_on_cb' => 'pscm_show_if_front_page', // function should return a bool value
		// 'context'    => 'normal',
		// 'priority'   => 'high',
		...
		// 'classes_cb' => 'pscm_add_some_classes', // Add classes through a callback.
	...
	$cmb_demo->add_field( array(
		...
		'id'         => 'pscm_demo_text',
		'type'       => 'text',
		'show_on_cb' => 'pscm_hide_if_no_cats', // function should return a bool value
	...
	$cmb_demo->add_field( array(
		...
		// );
		// 'display_cb' => 'pscm_display_text_small_column', // Output the display of the column values through a callback.
	) );

	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Text Medium', 'cmb2' ),
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'pscm_demo_textmedium',
		'type' => 'text_medium',
	) );
	...
	$cmb_demo->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'pscm_demo_render_row_cb',
		'type' => 'text',
		'render_row_cb' => 'pscm_render_row_cb',
	) );
	...
	$cmb_demo->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'pscm_demo_textdate_timestamp',
		'type' => 'text_date_timestamp',
		// 'timezone_meta_key' => 'pscm_demo_timezone', // Optionally make this field honor the timezone selected in the select_timezone specified above
	) );

	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Date/Time Picker Combo (UNIX timestamp)', 'cmb2' ),
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'pscm_demo_datetime_timestamp',
	...
	// 	'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
	// 	'id'   => 'pscm_demo_datetime_timestamp_timezone',
	...
	$cmb_demo->add_field( array(
		...
		'desc'     => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'       => 'pscm_demo_text_taxonomy_radio',
	...
	$cmb_demo->add_field( array(
		...
		'id'           => 'pscm_demo_parameters',
		'type'         => 'text',
		'before_row'   => 'pscm_before_row_if_2', // callback.
...
add_action( 'cmb2_admin_init', 'pscm_register_about_page_metabox' );
/**
 * Hook in and add a metabox that only appears on the 'About' page
 */
function pscm_register_about_page_metabox() {

	/**
	 * Metabox to be displayed on a single page ID
	 */
	$cmb_about_page = new_cmb2_box( array(
		'id'           => 'pscm_about_metabox',
...
add_action( 'cmb2_admin_init', 'pscm_register_repeatable_group_field_metabox' );
/**
 * Hook in and add a metabox to demonstrate repeatable grouped fields
 */
function pscm_register_repeatable_group_field_metabox() {

	/**
	 * Repeatable Field Groups
	 */
	$cmb_group = new_cmb2_box( array(
		'id'           => 'pscm_group_metabox',
		'title'        => esc_html__( 'Repeating Field Group', 'cmb2' ),
		'object_types' => array( 'page' ),
	) );

	// $group_field_id is the field id string, so in this case: 'pscm_group_demo'
...
add_action( 'cmb2_admin_init', 'pscm_register_user_profile_metabox' );
/**
 * Hook in and add a metabox to add fields to the user profile pages
 */
function pscm_register_user_profile_metabox() {
